package ru.maxizenit.lab5.service;

import ru.maxizenit.lab5.dao.ShapeDao;
import ru.maxizenit.lab5.model.field.Field;
import ru.maxizenit.lab5.model.shape.Reflectable;
import ru.maxizenit.lab5.model.shape.Rotatable;
import ru.maxizenit.lab5.model.shape.Shape;
import ru.maxizenit.lab5.util.PresetImage;
import ru.maxizenit.lab5.util.consts.Commands;
import ru.maxizenit.lab5.util.consts.Messages;
import ru.maxizenit.lab5.util.ShapeFactory;
import ru.maxizenit.lab5.util.consts.ShapeTitles;
...
public class CommandConsumer implements AutoCloseable {
  ...
  public CommandConsumer(
      InputStream inputStream, PrintStream printStream) throws IOException {
